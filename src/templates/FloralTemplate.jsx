...
export default function FloralTemplate({ lang, data, photo, photoSize = 'md', labels, fontScale = 1 }) {
    ...
    <div className="p-5 font-devanagari text-gray-900 bg-gradient-to-br from-fuchsia-50 to-purple-50" style={{ minHeight: '297mm' }}>
      <div className="border-2 border-fuchsia-400 rounded-lg p-4 h-full relative">
        ...
        <div className="mb-4 overflow-hidden">
          {photo && (
            <img src={photo} alt="Profile" className={`float-right ml-3 mb-3 ${photoClass} object-cover rounded-lg border-2 border-fuchsia-300 shadow`} />
          )}

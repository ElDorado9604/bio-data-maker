...
export default function ModernTemplate({ lang, data, photo, photoSize = 'md', labels, fontScale = 1 }) {
    ...
    <div className="font-devanagari text-gray-900" style={{ minHeight: '297mm' }}>
      ...
      <div className="p-6">
        <div className="mb-4 overflow-hidden">
          {photo && (
            <img src={photo} alt="Profile" className={`float-right ml-3 mb-3 ${photoClass} object-cover rounded-lg border-2 border-purple-200 shadow`} />
          )}
